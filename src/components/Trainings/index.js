          ...
          <div className="card-6" onClick={onHover6}>
            {hover6 ? (
              <div className="card__face-6 card__face--back-6">
                <ServicesH2>{i18n.t("trainings.trainingsDesc1")}</ServicesH2>
              </div>
            ) : (
              <div className="card__face-6 card__face--front-6">
                <ServicesH12>{i18n.t("trainings.trainingsTitle1")}</ServicesH12>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="card-7" onClick={onHover7}>
            {hover7 ? (
              <div className="card__face-7 card__face--back-7">
                <ServicesH2>{i18n.t("trainings.trainingsDesc2")}</ServicesH2>
              </div>
            ) : (
              <div className="card__face-7 card__face--front-7">
                <ServicesH12>{i18n.t("trainings.trainingsTitle2")}</ServicesH12>
              </div>
            )}
          </div>
        </div>
